...
_ITEMS: list[_Item] = [
    ...
    _Item("II", "1", "C", "1C002.b.6",
          "Reniummetall, legeringer og forbindelser",
          "Wassenaar",
          "7440-15-5, 10580-52-6, 14762-37-9",
          (
              "rhenium, renium, rhenium powder, reniumpulver, perrhenic acid, "
              "rhenium oxide, reniumoksid, Re"
          ),
          "2615.90"),

    _Item("II", "1", "C", "1C002.b.7",
          "Germaniummetall og forbindelser",
          "Wassenaar",
          "7440-56-4, 1310-53-8, 10038-98-9, 10529-52-9",
          (
              "germanium, germaniumdioksid, germanium dioxide, GeO2, "
              "germanium tetrachloride, germaniumtetraklorid, GeCl4"
          ),
          "2804.60, 8112.92"),

    # ══ Spesifikke metaller (1C011) — Wassenaar/NSG ══════════════════════════

    _Item("II", "1", "C", "1C011.a",
    ...
    _Item("II", "1", "C", "1C011.c",
          "Magnesiummetall (høyrent, >99,7 %)",
          "Wassenaar",
          "7439-95-4",
          (
              "magnesium, magnesiummetall, high purity magnesium, høyrent magnesium, "
              "magnesium powder, magnesiumpulver, Mg"
          ),
          "8104.11, 8104.19"),

    _Item("II", "1", "C", "1C011.d",
          "Litium anriket i Li-6 isotop",
          "NSG",
          "14258-74-3",
          (
              "lithium-6, litium-6, Li-6, enriched lithium, lithium isotope, "
              "litiumisotop, nuclear lithium, kjernelitium"
          ),
          "2805.12"),

    # ══ Nukleære materialer (1C232–1C234) — NSG ══════════════════════════════

    _Item("II", "1", "C", "1C232.a",
          "Tritium — kjernefysisk isotop",
          "NSG",
          "10028-17-8",
          (
              "tritium, T, hydrogen-3, tritium gas, tritiumgass, "
              "radioaktivt hydrogen, heavy hydrogen isotope"
          ),
          "2844.40"),

    _Item("II", "1", "C", "1C232.b",
    ...
    _Item("II", "1", "C", "1C111.a.4",
          "TNT (trinitrotoluen) — sprengstoff",
          "Wassenaar",
          "118-96-7",
          (
              "TNT, trinitrotoluene, trinitrotoluen, trotyl, "
              "2,4,6-trinitrotoluene, trilite, trinol"
          ),
          "2904.20, 3602.00"),

    _Item("II", "1", "C", "1C111.a.5",
    ...
    _Item("II", "1", "C", "1C111.c.1",
          "Nitrocellulose (høynitret, >12,5 % N)",
          "Wassenaar",
          "9004-70-0",
          (
              "nitrocellulose, nitroc, NC, cellulose nitrate, gun cotton, kruttpamull, "
              "collodion, pyroxylin"
          ),
    ...
    _Item("II", "1", "C", "1C350.12",
          "Trietanolamin — sennepsgass-forløper",
          "Australia Group",
          "102-71-6",
          (
              "triethanolamine, trietanolamin, TEA, "
              "tris(2-hydroxyethyl)amine, triethanol amine, TEOA"
          ),
          "2922.13"),

    _Item("II", "1", "C", "1C350.14",
          "Trietylamin",
          "Australia Group",
          "121-44-8",
          (
              "triethylamine, trietylamin, TEA, N,N-diethylethanamine, "
              "triethyl amine"
          ),
          "2921.19"),

    _Item("II", "1", "C", "1C350.18",
    ...
    _Item("II", "1", "C", "1C350.22",
          "QL — VX nervegass-forløper",
          "Australia Group",
          "57856-11-8",
          (
              "QL, O-Ethyl O-2-diisopropylaminoethyl methylphosphonite, "
              "VX precursor, VX-forløper, ethyl methylphosphonite"
          ),
          "2931.90"),

    _Item("II", "1", "C", "1C350.28",
    ...
    _Item("II", "1", "C", "1C350.57",
          "Trimetylfosfitt — syntetisk forløper",
          "Australia Group",
          "121-45-9",
          (
              "trimethyl phosphite, trimetylfosfitt, phosphorous acid trimethyl ester, "
              "TMP, trimethoxyphosphine"
          ),
          "2920.90"),

    _Item("II", "1", "C", "1C350.59",
          "Diklordifenyltriklormetan (DDT) og analoge — ikke kontrollert",
          "Australia Group",
          "107-49-3",
          (
              "TEPP, tetraethyl pyrophosphate, tetraetylpyrofosfat, "
    ...
    _Item("II", "1", "C", "1C450.a.1",
          "Amiton — obsolet plantevernmiddel/nervegass",
          "Australia Group",
          "78-53-5",
          (
              "amiton, VG, O,O-Diethyl S-[2-(diethylamino)ethyl] phosphorothioate, "
              "tetram"
          ),
          "2931.90"),

    _Item("II", "1", "C", "1C450.a.5",
          "BZ — inkapasiteringsmiddel",
          "Australia Group",
          "6581-06-2",
          (
              "BZ, 3-quinuclidinyl benzilate, QNB, agent BZ, "
              "incapacitating agent, inkapasiteringsmiddel"
          ),
          "2933.39"),

    _Item("II", "1", "C", "1C450.a.7",
          "Dimetylsulfat — toksisk alkylerende stoff",
          "Australia Group",
          "77-78-1",
          (
              "dimethyl sulfate, dimetylsulfat, methyl sulfate, DMS, "
              "sulfuric acid dimethyl ester, dimethyl sulphate"
          ),
          "2920.19"),

    _Item("II", "1", "C", "1C450.b.1",
          "Hydrogencyanid (prusisk syre)",
          "Australia Group",
          "74-90-8",
          (
              "hydrogen cyanide, hydrogencyanid, prussic acid, prusisk syre, "
              "HCN, formonitrile, blåsyre"
          ),
          "2837.11, 2837.19"),

    _Item("II", "1", "C", "1C450.b.3",
          "Fosgen (karbonylklorid)",
          "Australia Group",
          "75-44-5",
          (
              "phosgene, fosgen, carbonyl chloride, karbonylklorid, "
    ...
    _Item("I", "ML7", None, "ML7.f.3",
          "Tåregass — CN-gass (klloracetofenon)",
          "Wassenaar",
          "532-27-4",
          (
              "CN gas, CN, chloroacetophenone, kloracetofenon, mace, "
              "tear gas, tåregass, riot control agent"
          ),
          "2914.79"),
]
...
async def _run(dry_run: bool) -> None:
    ...
    print(
        f"Ferdig: {created} nye, {updated} oppdatert "
        f"({created + updated} totalt, kilde='{SOURCE_VERSION}')."
    )
