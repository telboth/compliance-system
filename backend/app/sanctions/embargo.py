...
SEED_LIST: tuple[EmbargoEntry, ...] = (
    ...
    EmbargoEntry(
        iso2="KP",
        name="Nord-Korea (DPRK)",
        sources=("UN", "EU", "NO", "US"),
        scope="comprehensive",
        note="FN SR res. 1718 (2006) og 2397 (2017). Totalforbud mot eksport av nesten alle varer, inkl. dual-use.",
    ),
    EmbargoEntry(
        iso2="IR",
        name="Iran",
        sources=("UN", "EU", "NO", "US"),
        scope="comprehensive",
        note="OFAC Iran Sanctions + EU-forordning 267/2012. Totalforbud inkl. dual-use og militaert materiell.",
    ),
    EmbargoEntry(
        iso2="SY",
        name="Syria",
    ...
    EmbargoEntry(
        ...
        sources=("EU", "US"),
        scope="sectoral",
        note="EU-forordning 401/2013. Forbud mot militaert og dual-use materiell etter militaerkuppet i 2021.",
    ),
    EmbargoEntry(
        iso2="SD",
        name="Sudan",
        sources=("UN", "US"),
        scope="sectoral",
        note="OFAC Sudan Sanctions + FN-vapenembargo. Forbudt: vapen og militaert utstyr til Darfur.",
    ),
    EmbargoEntry(
        iso2="SS",
        name="Sor-Sudan",
    ...
    EmbargoEntry(
        ...
        sources=("UN",),
        scope="sectoral",
        note="FN SR res. 1701 (2006). Restriksjoner mot bevapning av ikke-statlige grupper.",
    ),
    EmbargoEntry(
        iso2="VE",
        name="Venezuela",
    ...
    EmbargoEntry(
        ...
        sources=("EU",),
        scope="sectoral",
        note="EU-forordning 2011/101. Forbud mot vapen og internt undertrykkingsutstyr.",
    ),
    EmbargoEntry(
        iso2="HT",
        name="Haiti",
...
ALL_SANCTIONED_COUNTRIES: frozenset[str] = frozenset(e.iso2.upper() for e in SEED_LIST)
