...
LIST_I_CATEGORIES: tuple[ControlCategory, ...] = (
    ControlCategory("I", "ML1", "Glattborede våpen under 20 mm, andre våpen ≤12,7 mm",
                    "Smooth-bore weapons <20mm, other arms ≤12.7mm",
                    ("rifle", "carbine", "pistol", "revolver", "machine gun", "submachine gun",
                     "assault rifle", "firearm", "shotgun", "musket", "gevær",
                     "automatvåpen"),
                    "Wassenaar"),
    ControlCategory("I", "ML2", "Glattborede våpen ≥20 mm, andre våpen >12,7 mm, kanoner",
                    "Weapons ≥20mm, other weapons/armament >12.7mm, mortars",
                    ("cannon", "howitzer", "mortar", "grenade launcher", "artillery",
                     "autocannon", "kanon", "bombekaster", "granatkaster"),
                    "Wassenaar"),
    ControlCategory("I", "ML3", "Ammunisjon og tennmekanismer",
                    "Ammunition and fuze setting devices",
                    ("ammunition", "cartridge", "fuze", "fuse", "projectile", "shell",
                     "round", "tracer", "ammunisjon", "patron", "prosjektil"),
                    "Wassenaar"),
    ControlCategory("I", "ML4", "Bomber, torpedoer, raketter, missiler",
                    "Bombs, torpedoes, rockets, missiles, related equipment",
                    ("bomb", "torpedo", "missile", "rocket", "warhead", "mine", "depth charge",
                     "ied", "stridshode", "missil", "rakett"),
                    "MTCR"),
    ControlCategory("I", "ML5", "Ildledning og tilhørende varslingsutstyr",
                    "Fire control, surveillance and warning equipment",
                    ("fire control", "weapon sight", "laser rangefinder", "target acquisition",
                     "ildledning", "siktemiddel"),
                    "Wassenaar"),
    ControlCategory("I", "ML6", "Landkjøretøy og komponenter",
                    "Ground vehicles and components",
                    ("armoured vehicle", "armored vehicle", "tank", "military vehicle", "apc",
                     "infantry fighting vehicle", "pansret kjøretøy", "stridsvogn"),
                    "Wassenaar"),
    ControlCategory("I", "ML7", "Kjemiske/biologiske stridsmidler og opprørskontroll",
                    "Chemical/biological agents, riot control agents",
                    ("nerve agent", "tear gas", "cs gas", "riot control", "toxin",
                     "chemical agent", "nervegass", "tåregass"),
                    "CWC"),
    ControlCategory("I", "ML8", "Energetiske materialer og relaterte stoffer",
                    "Energetic materials and related substances (explosives, propellants)",
                    ("explosive", "rdx", "hmx", "tnt", "petn", "propellant", "nitrocellulose",
                     "eksplosiv", "krutt", "drivladning"),
                    "Wassenaar"),
    ControlCategory("I", "ML9", "Krigsfartøyer og marint utstyr",
                    "Vessels of war and special naval equipment",
                    ("warship", "submarine", "naval vessel", "torpedo tube", "minesweeper",
                     "krigsfartøy", "ubåt", "marinefartøy"),
                    "Wassenaar"),
    ControlCategory("I", "ML10", "Luftfartøyer, UAV-er og flymotorer",
                    "Aircraft, UAVs, aero engines and equipment",
                    ("military aircraft", "fighter jet", "uav", "unmanned aerial", "drone",
                     "aero engine", "kampfly", "militært luftfartøy"),
                    "MTCR"),
    ControlCategory("I", "ML11", "Elektronisk utstyr (militært)",
                    "Electronic equipment, spacecraft and components (military)",
                    ("electronic warfare", "jamming", "ecm", "countermeasure", "military radar",
                     "elektronisk krigføring", "jamming"),
                    "Wassenaar"),
    ControlCategory("I", "ML12", "Høyhastighets kinetiske energivåpen",
                    "High velocity kinetic energy weapon systems",
                    ("railgun", "kinetic energy weapon", "kinetisk energivåpen"),
                    "Wassenaar"),
    ControlCategory("I", "ML13", "Pansret eller beskyttende utstyr",
                    "Armoured or protective equipment",
                    ("body armour", "body armor", "ballistic protection", "armour plate",
                     "helmet", "skuddsikker", "kroppspanser"),
                    "Wassenaar"),
    ControlCategory("I", "ML14", "Spesialisert treningsutstyr",
                    "Specialised equipment for military training",
                    ("military simulator", "training simulator", "militær simulator"),
                    "Wassenaar"),
    ControlCategory("I", "ML15", "Bildedannende og mottiltaksutstyr",
                    "Imaging or countermeasure equipment (military)",
                    ("night vision", "thermal imaging", "image intensifier",
                     "nattsyn", "termisk avbildning"),
                    "Wassenaar"),
    ControlCategory("I", "ML16", "Smigods, støpegods og halvfabrikata",
                    "Forgings, castings and unfinished products for ML items",
                    ("forging", "casting", "smigods", "støpegods"),
                    "Wassenaar"),
    ControlCategory("I", "ML17", "Diverse utstyr, materialer og biblioteker",
                    "Miscellaneous equipment, materials and libraries",
                    ("military robot", "military diving", "armoured shelter"),
                    "Wassenaar"),
    ControlCategory("I", "ML18", "Produksjonsutstyr for ML-varer",
                    "Production equipment for ML items",
                    ("production equipment", "produksjonsutstyr militært"),
                    "Wassenaar"),
    ControlCategory("I", "ML19", "Rettede energivåpensystemer",
                    "Directed energy weapon systems",
                    ("directed energy", "laser weapon", "high power microwave",
                     "rettet energivåpen", "laservåpen"),
                    "Wassenaar"),
    ControlCategory("I", "ML20", "Kryogenisk og superledende utstyr (militært)",
                    "Cryogenic and superconductive equipment (military)",
                    ("cryogenic military", "superconductive military"),
                    "Wassenaar"),
    ControlCategory("I", "ML21", "Programvare (militær)",
                    "Software for military use",
                    ("military software", "fire control software", "militær programvare"),
                    "Wassenaar"),
    ControlCategory("I", "ML22", "Teknologi (militær)",
...
LIST_II_CATEGORIES: tuple[ControlCategory, ...] = (
    ControlCategory("II", "0", "Kjernefysiske materialer, anlegg og utstyr",
                    "Nuclear materials, facilities and equipment",
                    ("uranium", "plutonium", "centrifuge", "nuclear reactor", "heavy water",
                     "isotope separation", "tritium", "zirconium", "uran", "plutonium",
                     "sentrifuge", "kjernereaktor", "tungtvann"),
                    "NSG"),
    ControlCategory("II", "1", "Spesielle materialer og tilhørende utstyr",
                    "Special materials and related equipment",
                    ("carbon fiber", "carbon fibre", "aramid", "composite material",
                     "chemical precursor", "toxic", "fluorinated", "boron", "tungsten",
                     "karbonfiber", "kompositt", "kjemisk forløper"),
                    "AG"),
    ControlCategory("II", "2", "Materialbearbeiding",
                    "Materials processing",
                    ("machine tool", "cnc", "five axis", "isostatic press", "bearing",
                     "robot", "spin forming", "flow forming", "verktøymaskin", "dreiebenk",
                     "fresemaskin", "industrirobot"),
                    "Wassenaar"),
    ControlCategory("II", "3", "Elektronikk",
                    "Electronics",
                    ("integrated circuit", "microprocessor", "fpga", "asic", "adc",
                     "radiation hardened", "microwave", "vacuum electronic", "semiconductor",
                     "integrert krets", "mikroprosessor", "halvleder"),
                    "Wassenaar"),
    ControlCategory("II", "4", "Datamaskiner",
                    "Computers",
                    ("supercomputer", "high performance computing", "hpc",
                     "neural computer", "tflops", "superdatamaskin", "tungregning"),
                    "Wassenaar"),
    ControlCategory("II", "5", "Telekommunikasjon og informasjonssikkerhet",
                    "Telecommunications and information security (cryptography)",
                    ("encryption", "cryptography", "cryptographic", "telecommunication",
                     "signal processing", "jamming", "monitoring", "interception",
                     "kryptering", "kryptografi", "telekommunikasjon"),
                    "Wassenaar"),
    ControlCategory("II", "6", "Sensorer og lasere",
                    "Sensors and lasers",
                    ("laser", "sensor", "radar", "sonar", "hydrophone", "accelerometer",
                     "gyroscope", "infrared", "focal plane array", "night vision", "lidar",
                     "laser", "sensor", "radar", "gyroskop", "infrarød"),
                    "Wassenaar"),
    ControlCategory("II", "7", "Navigasjon og luftelektronikk",
                    "Navigation and avionics",
                    ("inertial navigation", "ins", "imu", "gyroscope", "accelerometer",
                     "gnss", "gps receiver", "flight control", "avionics",
                     "treghetsnavigasjon", "flynavigasjon"),
                    "MTCR"),
    ControlCategory("II", "8", "Marine",
                    "Marine",
                    ("submersible", "submarine", "underwater vehicle", "rov", "auv",
                     "diving system", "marine propulsion", "undervannsfartøy", "dykkersystem"),
                    "Wassenaar"),
    ControlCategory("II", "9", "Luft- og romfart samt fremdrift",
                    "Aerospace and propulsion",
                    ("gas turbine", "jet engine", "rocket engine", "turbojet", "turbofan",
                     "uav", "spacecraft", "propellant", "ramjet", "gassturbin", "jetmotor",
                     "rakettmotor", "romfartøy"),
                    "MTCR"),
)
